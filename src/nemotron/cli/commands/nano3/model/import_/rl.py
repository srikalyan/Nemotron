...
def rl(
    ...
    Examples:
        nemotron nano3 model import rl /path/to/model --step 2000
        nemotron nano3 model import rl /path/to/model --step 2000 --project my-project
    """
    ...
    # Create artifact
    artifact_name = name or "nano3/rl/model"
